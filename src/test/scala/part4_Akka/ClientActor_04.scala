...
object ClientActor_04 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    // 创建dispatch | mailbox
    val clientActorRef = clientActorSystem.actorOf(Props(new ClientActor_04(serverHost, serverPort.toInt)), "Client")
...
class ClientActor_04(host: String, port: Int) extends Actor{
